...
public class GstMultipleNetworkPlayer:IGstPlayer  {
	...
	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private System.IntPtr mray_gst_multiNetPlayerGetData(System.IntPtr p, int index);
	...
	public System.IntPtr CopyTextureData( byte[] _dataPtr,int index )
	{
        ...
        var ptr = mray_gst_multiNetPlayerGetData(m_Instance, index);	
		if(_dataPtr!=null)
			Marshal.Copy(ptr,_dataPtr,0, len);
		return ptr;
	}
