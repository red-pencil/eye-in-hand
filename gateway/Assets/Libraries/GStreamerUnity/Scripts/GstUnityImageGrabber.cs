...
public class GstUnityImageGrabber {
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void mray_gst_destroyUnityImageGrabber(System.IntPtr inst);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void mray_gst_UnityImageGrabberSetImageInfo(System.IntPtr p, System.IntPtr img);
    ...
    public System.IntPtr ImageInfo;
    ...
    public void Destroy()
    {
      ...
      //  mray_gst_destroyUnityImageGrabber(m_Instance);
	...
	public void SetTexture2D(byte[] texture,int width,int height,TextureFormat format)
	{
		...
		if (m_Texture.Length != m_lastArrayLength) {
            ...
            m_lastArrayLength = m_Texture.Length;
    ...
    public void Update()
    {
        if (ImageInfo != null)
        {
            mray_gst_UnityImageGrabberSetImageInfo(m_Instance, ImageInfo);
        }
        else
        {
            if (m_Texture == null)
