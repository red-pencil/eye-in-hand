...
public class GstNetworkAudioPlayer:IGstPlayer  {
	...
	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private float mray_gst_ProcessAudioPackets([In,Out] float[] srcData,int startIndex,int channelIndex,int count,int stride,int srcChannels,[In,Out] float[] data,int length,int channels,bool modulate);

	public static float ProcessAudioPackets([In,Out] float[] srcData,int startIndex,int channelIndex,int count,int stride,int srcChannels,[In,Out] float[] data,int offset,int channels,bool modulate)
	{
		return mray_gst_ProcessAudioPackets (srcData, startIndex, channelIndex, count, stride, srcChannels, data, offset, channels,modulate);
	}
