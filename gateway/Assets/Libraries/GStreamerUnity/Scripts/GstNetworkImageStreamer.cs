...
public class GstNetworkImageStreamer:IGstStreamer {
	...
	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private int mray_gst_netStreamerSetBitRate(System.IntPtr p,int bitRate,int quality);
	...
	public void SetBitRate(int bitrate,int quality=-1)
	{
		mray_gst_netStreamerSetBitRate (m_Instance, bitrate, quality);
	}
