...
public class SeethroughLayerDuplicatorComponent : MonoBehaviour, IDependencyNode {
	...
	void _UpdateTextures()
	{
		...
		Texture tex = SrcLayer.Provider.GetTexture(TargetStream);
		...
		float strength = _srcMtrl.GetFloat ("_Strength");
