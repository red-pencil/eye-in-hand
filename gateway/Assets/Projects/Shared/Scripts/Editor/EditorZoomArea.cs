...
public class EditorZoomArea
{
    ...
    private static Stack<Matrix4x4> previousMatricesHandles = new Stack<Matrix4x4>();
    ...
    public static Rect Begin(float zoomScale, Rect screenCoordsArea)
    {
        ...
        previousMatricesHandles.Push(Handles.matrix);
        Matrix4x4 translation = Matrix4x4.TRS(clippedArea.center, Quaternion.identity, Vector3.one);
        Matrix4x4 scale = Matrix4x4.Scale(new Vector3(zoomScale, zoomScale, 1.0f));
        GUI.matrix = translation * scale * translation.inverse* GUI.matrix;
        InverseMatrix = GUI.matrix.inverse;

        Handles.matrix = GUI.matrix;// scale * Handles.matrix;// translation * scale * translation.inverse * Handles.matrix;
    ...
    public static void End()
    {
        ...
        Handles.matrix = previousMatricesHandles.Pop();
        GUI.EndGroup();
